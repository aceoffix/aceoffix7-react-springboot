...
### 2. Project environmental prerequisites
   ...
   **React**: React 18 and  and later versions
...
- **front - end**
  - Open the `aceoffix7-react-front` folder with a development tool like Visual Studio Code. Navigate into this folder and then use the `npm run start` command to start and run the project.
...
- **back- end**
  ...
  - Run `aceoffix7-springboot2-back`  to see the sample effect.
