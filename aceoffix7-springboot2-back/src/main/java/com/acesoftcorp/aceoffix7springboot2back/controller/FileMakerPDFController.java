...
public class FileMakerPDFController {
    ...
    @RequestMapping(value = "/FileMakerPDF",method = RequestMethod.POST)
    public void showWord(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        fmCtrl.fillDocumentAsPDF("/doc/FileMakerPDF/template.docx", DocumentOpenType.Word, "zhengshu.pdf");
    ...
    public void save(HttpServletRequest request, HttpServletResponse response) {
        ...
        fs.saveToFile(dir + "FileMakerPDF/" + fileName);
