...
public class WordTableSetImgController {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        table1.openCellRC(1, 1).setValue("[image]/doc/WordTableSetImg/logo.png[/image]");
        ...
        aceCtrl.webOpen("/doc/WordTableSetImg/test_table.docx", OpenModeType.docNormalEdit, "Luna");
