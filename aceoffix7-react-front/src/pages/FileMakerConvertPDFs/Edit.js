...
const Edit = () => {
  ...
  const Save = () => {
    aceoffixctrl.SaveFilePage = "/FileMakerConvertPDFs/save?id="+JSON.parse(aceoffixctrl.WindowParams);
  ...
  const openFile = async () => {
    try {
      const response = await service.post("/FileMakerConvertPDFs/edit?id="+JSON.parse(aceoffixctrl.WindowParams));
      return response;
    } catch (error) {
