...
const Word = () => {
  ...
  const Save = () => {
   aceoffixctrl.SaveFilePage = "/ExaminationPaper/save?id="+aceoffixctrl.WindowParams;
  ...
  const openFile = async () => {
    try {
      const response = await service.post('/ExaminationPaper/word?id='+aceoffixctrl.WindowParams);
      return response;
    } catch (error) {
