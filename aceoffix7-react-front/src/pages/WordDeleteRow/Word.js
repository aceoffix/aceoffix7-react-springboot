...
const Word = () => {
  ...
  const openFile = async () => {
    try {
      const response = await service.post("/WordDeleteRow/Word");
      return response;
    } catch (error) {
  ...
  return (
    <div className="showDoc">
       <div style={{color:"red"}}>The row containing the cell at coordinates (2,1) in the table has been deleted.</div>
